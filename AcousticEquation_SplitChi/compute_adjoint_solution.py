...
for t in range(len(history_reverse)):
    recepteur[t,:] = dchi(history_reverse, history_obs, t*dt, dt, index_receivers, max_obs, which_chi)[2,index_receivers]
...
t_start, U_start, history_adjoint = time_scheme(get_adjoint_RHS, U_start, T_init, Tmax, z, "adjoint", U0, T0, g, 0, 0, 0, gamma, Cv, h, dt, source, history_reverse, history_obs, index_receivers, max_obs, which_chi)
