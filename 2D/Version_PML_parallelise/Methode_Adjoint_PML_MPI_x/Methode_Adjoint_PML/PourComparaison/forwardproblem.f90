...
!-----------------------------------------------------------------------
  ...
  do j = 1,NY
	...
	u_mm = vx(Im1,j); u_m = vx(i,j); u_p = vx(Ip1,j); u_pp = vx(Ip2,j)
        ...
        eq1_memory_dvx_dx_fw(i,j) = b_x_half(i) * eq1_memory_dvx_dx_fw(i,j) + a_x_half(i) * value_dvx_dx
        eq1_memory_dvy_dy_fw(i,j) = b_y(j) * eq1_memory_dvy_dy_fw(i,j) + a_y(j) * value_dvy_dy
        eq1_memory_dwindx_dx_fw(i,j) = c_x_half(i) * value_dwindx_dx
        ...
        eq1_memory_dpressure_dx_fw(i,j) = b_x_half(i) * eq1_memory_dpressure_dx_fw(i,j) + a_x_half(i) * value_dpressure_dx
        eq1_memory_drhop_dx_fw(i,j) = b_x_half(i) * eq1_memory_drhop_dx_fw(i,j) + a_x_half(i) * value_drhop_dx
        eq1_memory_dp0_dx_fw(i,j) = c_x_half(i) * value_dp0_dx
        eq1_memory_drho0_dx_fw(i,j) = c_x_half(i) * value_drho0_dx 
        ...
        ! 
        value_dvx_dx = value_dvx_dx * one_over_K_x_half(i) + eq1_memory_dvx_dx_fw(i,j)
        value_dvy_dy = value_dvy_dy * one_over_K_y(j) + eq1_memory_dvy_dy_fw(i,j) 
        value_dwindx_dx = value_dwindx_dx * one_over_K_x_half(i) + eq1_memory_dwindx_dx_fw(i,j)
        value_dwindy_dy = value_dwindy_dy * one_over_K_y(j) + eq1_memory_dwindy_dy_fw(i,j) 
        
        value_dp0_dx = value_dp0_dx * one_over_K_x_half(i) + eq1_memory_dp0_dx_fw(i,j)
        value_drho0_dx = value_drho0_dx * one_over_K_x_half(i) + eq1_memory_drho0_dx_fw(i,j)
        value_dpressure_dx = value_dpressure_dx * one_over_K_x_half(i) + eq1_memory_dpressure_dx_fw(i,j)
        value_drhop_dx = value_drhop_dx * one_over_K_x_half(i) + eq1_memory_drhop_dx_fw(i,j)
...
!--------------------------------------------------------
  ...
  do j = 1,NY
    do i = 1,NX
      ...
      eq2_memory_drho0_dx_fw(i,j) = c_x(i) * value_drho0_dx
      eq2_memory_dpressure_dx_fw(i,j) = b_x(i) * eq2_memory_dpressure_dx_fw(i,j) + a_x(i) * value_dpressure_dx
      ...
      eq2_memory_dwindx_dx_fw(i,j) = c_x(i) * value_dwindx_dx
      eq2_memory_dvx_dx_fw(i,j) = b_x(i) * eq2_memory_dvx_dx_fw(i,j) + a_x(i) * value_dvx_dx
     ...
     !
     value_dpressure_dx = value_dpressure_dx * one_over_K_x(i) + eq2_memory_dpressure_dx_fw(i,j)
     value_drho0_dx = value_drho0_dx * one_over_K_x(i) + eq2_memory_drho0_dx_fw(i,j)
     
     value_dvx_dx = value_dvx_dx * one_over_K_x(i) + eq2_memory_dvx_dx_fw(i,j)
     value_dwindx_dx = value_dwindx_dx * one_over_K_x(i) + eq2_memory_dwindx_dx_fw(i,j)
...
!     interpolate density at the right location in the staggered grid cell
      ...
      eq3_memory_dwindy_dx_fw(i,j) = c_x_half(i) * value_dwindy_dx
      ...
      eq3_memory_drho0_dx_fw(i,j) = c_x_half(i) * value_drho0_dx
     ...
     ! compute derivative of windx according to x
      ...
      eq3_memory_dwindx_dx_fw(i,j) = c_x_half(i) * value_dwindx_dx
      ...
      value_dvy_dx = value_dvy_dx *  one_over_K_x_half(i) + eq3_memory_dvy_dx_fw(i,j)
      value_dwindy_dx = value_dwindy_dx *  one_over_K_x_half(i) + eq3_memory_dwindy_dx_fw(i,j)
      
      value_drho0_dx = value_drho0_dx * one_over_K_x_half(i) + eq3_memory_drho0_dx_fw(i,j)
      
      value_dwindx_dx = value_dwindx_dx * one_over_K_x_half(i) + eq3_memory_dwindx_dx_fw(i,j)
