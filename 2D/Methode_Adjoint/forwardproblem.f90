subroutine forwardproblem(CI_pressure,CI_rhop,CI_vx,CI_vy,  p0,rho,v0x,v0y,kappa_unrelaxed, time_start,time_end, field_number) 
 !
...
! interpolate material parameters at the right location in the staggered grid cell
        ...
        call compute_decentered_dU_dx_in_i(v0y, i, j, value_dv0y_dx_next,ONE_OVER_SIX_DELTAX,NX,NY,v0x_half_x_half_y)
        call compute_decentered_dU_dz_in_i(v0x, Ip1, j, value_dv0x_dy_next,ONE_OVER_SIX_DELTAY,NX,NY,v0y_half_x_half_y)
...
! output information
  if ((mod(it,IT_DISPLAY) == 0 .or. it == 5) .and. (.not. use_checkpoint)) then
