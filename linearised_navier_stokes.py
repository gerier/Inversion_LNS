...
if not decentered_backward_and_forward : 
    ...
    def get_RHS(U1, t, U0, T0, g, l, mu, kappa, gamma, R, dz, dt, source, is_reverse, order_DF=4):
        ...
        return F(U1, U0, int(abs(t/dt)), source, len(U1.rho)) + G(U1, U0, dz, g, is_reverse, DF_C, DF_DC) \
    ...
    def get_RHS(U1, t, U0, T0, g, l, mu, kappa, gamma, R, dz, dt, source, is_reverse, order_DF=4):
        ...
        RHS_c = F(U1, U0, int(abs(t/dt)), source, len(U1.rho), gamma) + G_C(U1, U0, dz, g, is_reverse) \
