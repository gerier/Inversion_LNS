...
!-----------------------------------------------------------------------
  ...
  ! vx
  call MPI_SENDRECV(vx(1:2,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
         receiver_left_shift,message_tag,vx(NX_LOCAL+1:NX_LOCAL+2,:),number_of_values_x, &
         MPI_DOUBLE_PRECISION,sender_left_shift,message_tag,MPI_COMM_WORLD,message_status,code)
  call MPI_SENDRECV(vx(NX_LOCAL-1:NX_LOCAL,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
         receiver_right_shift,message_tag,vx(-1:0,:),number_of_values_x, &
         MPI_DOUBLE_PRECISION,sender_right_shift,message_tag,MPI_COMM_WORLD,message_status,code)
     
  ! windx       
  call MPI_SENDRECV(windx(1:2,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
         receiver_left_shift,message_tag,windx(NX_LOCAL+1:NX_LOCAL+2,:),number_of_values_x, &
         MPI_DOUBLE_PRECISION,sender_left_shift,message_tag,MPI_COMM_WORLD,message_status,code)
  call MPI_SENDRECV(windx(NX_LOCAL-1:NX_LOCAL,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
         receiver_right_shift,message_tag,windx(-1:0,:),number_of_values_x, &
         MPI_DOUBLE_PRECISION,sender_right_shift,message_tag,MPI_COMM_WORLD,message_status,code)

  ! vy
  call MPI_SENDRECV(vy(NX_LOCAL-1:NX_LOCAL,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
         receiver_right_shift,message_tag,vy(-1:0,:),number_of_values_x, &
         MPI_DOUBLE_PRECISION,sender_right_shift,message_tag,MPI_COMM_WORLD,message_status,code)
  call MPI_SENDRECV(vy(1:2,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
         receiver_left_shift,message_tag,vy(NX_LOCAL+1:NX_LOCAL+2,:),number_of_values_x, &
         MPI_DOUBLE_PRECISION,sender_left_shift,message_tag,MPI_COMM_WORLD,message_status,code)
         
   call MPI_SENDRECV(vy(:,NY_LOCAL-1:NY_LOCAL),number_of_values_y,MPI_DOUBLE_PRECISION, &
         receiver_top_shift,message_tag,vy(:,-1:0),number_of_values_y, &
         MPI_DOUBLE_PRECISION,sender_top_shift,message_tag,MPI_COMM_WORLD,message_status,code)
   call MPI_SENDRECV(vy(:,1:2),number_of_values_y,MPI_DOUBLE_PRECISION, &
         receiver_bottom_shift,message_tag,vy(:,NY_LOCAL+1:NY_LOCAL+2),number_of_values_y, &
         MPI_DOUBLE_PRECISION,sender_bottom_shift,message_tag,MPI_COMM_WORLD,message_status,code)


  ! windy       
  call MPI_SENDRECV(windy(NX_LOCAL-1:NX_LOCAL,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
         receiver_right_shift,message_tag,windy(-1:0,:),number_of_values_x, &
         MPI_DOUBLE_PRECISION,sender_right_shift,message_tag,MPI_COMM_WORLD,message_status,code)
   call MPI_SENDRECV(windy(1,:),number_of_values_x/2,MPI_DOUBLE_PRECISION, &
         receiver_left_shift,message_tag,windy(NX_LOCAL+1,:),number_of_values_x/2, &
         MPI_DOUBLE_PRECISION,sender_left_shift,message_tag,MPI_COMM_WORLD,message_status,code)

   call MPI_SENDRECV(windy(:,NY_LOCAL-1:NY_LOCAL),number_of_values_y,MPI_DOUBLE_PRECISION, &
         receiver_top_shift,message_tag,windy(:,-1:0),number_of_values_y, &
         MPI_DOUBLE_PRECISION,sender_top_shift,message_tag,MPI_COMM_WORLD,message_status,code)
   call MPI_SENDRECV(windy(:,1:2),number_of_values_y,MPI_DOUBLE_PRECISION, &
         receiver_bottom_shift,message_tag,windy(:,NY_LOCAL+1:NY_LOCAL+2),number_of_values_y, &
         MPI_DOUBLE_PRECISION,sender_bottom_shift,message_tag,MPI_COMM_WORLD,message_status,code)


  ! rhop 
   call MPI_SENDRECV(rhop_old(NX_LOCAL-1:NX_LOCAL,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
         receiver_right_shift,message_tag,rhop_old(-1:0,:),number_of_values_x, &
         MPI_DOUBLE_PRECISION,sender_right_shift,message_tag,MPI_COMM_WORLD,message_status,code)
   call MPI_SENDRECV(rhop_old(1:2,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
         receiver_left_shift,message_tag,rhop_old(NX_LOCAL+1:NX_LOCAL+2,:),number_of_values_x, &
         MPI_DOUBLE_PRECISION,sender_left_shift,message_tag,MPI_COMM_WORLD,message_status,code)
        
   call MPI_SENDRECV(rhop_old(:,NY_LOCAL-1:NY_LOCAL),number_of_values_y,MPI_DOUBLE_PRECISION, &
         receiver_top_shift,message_tag,rhop_old(:,-1:0),number_of_values_y, &
         MPI_DOUBLE_PRECISION,sender_top_shift,message_tag,MPI_COMM_WORLD,message_status,code)
   call MPI_SENDRECV(rhop_old(:,1:2),number_of_values_y,MPI_DOUBLE_PRECISION, &
         receiver_bottom_shift,message_tag,rhop_old(:,NY_LOCAL+1:NY_LOCAL+2),number_of_values_y, &
         MPI_DOUBLE_PRECISION,sender_bottom_shift,message_tag,MPI_COMM_WORLD,message_status,code)


  ! pp
   call MPI_SENDRECV(p_old(NX_LOCAL-1:NX_LOCAL,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
         receiver_right_shift,message_tag,p_old(-1:0,:),number_of_values_x, &
         MPI_DOUBLE_PRECISION,sender_right_shift,message_tag,MPI_COMM_WORLD,message_status,code)
   call MPI_SENDRECV(p_old(1:2,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
         receiver_left_shift,message_tag,p_old(NX_LOCAL+1:NX_LOCAL+2,:),number_of_values_x, &
         MPI_DOUBLE_PRECISION,sender_left_shift,message_tag,MPI_COMM_WORLD,message_status,code)
  
   call MPI_SENDRECV(p_old(:,NY_LOCAL-1:NY_LOCAL),number_of_values_y,MPI_DOUBLE_PRECISION, &
         receiver_top_shift,message_tag,p_old(:,-1:0),number_of_values_y, &
         MPI_DOUBLE_PRECISION,sender_top_shift,message_tag,MPI_COMM_WORLD,message_status,code)
   call MPI_SENDRECV(p_old(:,1:2),number_of_values_y,MPI_DOUBLE_PRECISION, &
         receiver_bottom_shift,message_tag,p_old(:,NY_LOCAL+1:NY_LOCAL+2),number_of_values_y, &
         MPI_DOUBLE_PRECISION,sender_bottom_shift,message_tag,MPI_COMM_WORLD,message_status,code)
     
      
  ! rho0
  ! call MPI_SENDRECV(rho0(NX_LOCAL-1:NX_LOCAL,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
  !       receiver_right_shift,message_tag,rho0(-1:0,:),number_of_values_x, &
  !       MPI_DOUBLE_PRECISION,sender_right_shift,message_tag,MPI_COMM_WORLD,message_status,code)
  ! call MPI_SENDRECV(rho0(1:2,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
  !       receiver_left_shift,message_tag,rho0(NX_LOCAL+1:NX_LOCAL+2,:),number_of_values_x, &
  !       MPI_DOUBLE_PRECISION,sender_left_shift,message_tag,MPI_COMM_WORLD,message_status,code)
 
  !  call MPI_SENDRECV(rho0(:,NY_LOCAL-1:NY_LOCAL),number_of_values_y,MPI_DOUBLE_PRECISION, &
  !       receiver_top_shift,message_tag,rho0(:,-1:0),number_of_values_y, &
  !       MPI_DOUBLE_PRECISION,sender_top_shift,message_tag,MPI_COMM_WORLD,message_status,code)
  ! call MPI_SENDRECV(rho0(:,1:2),number_of_values_y,MPI_DOUBLE_PRECISION, &
  !       receiver_bottom_shift,message_tag,rho0(:,NY_LOCAL+1:NY_LOCAL+2),number_of_values_y, &
  !       MPI_DOUBLE_PRECISION,sender_bottom_shift,message_tag,MPI_COMM_WORLD,message_status,code)
           
  ! p0
  ! call MPI_SENDRECV(p0(NX_LOCAL-1:NX_LOCAL,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
  !       receiver_right_shift,message_tag,p0(-1:0,:),number_of_values_x, &
  !       MPI_DOUBLE_PRECISION,sender_right_shift,message_tag,MPI_COMM_WORLD,message_status,code)
  ! call MPI_SENDRECV(p0(1:2,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
  !       receiver_left_shift,message_tag,p0(NX_LOCAL+1:NX_LOCAL+2,:),number_of_values_x, &
  !       MPI_DOUBLE_PRECISION,sender_left_shift,message_tag,MPI_COMM_WORLD,message_status,code)

  ! call MPI_SENDRECV(p0(:,NY_LOCAL-1:NY_LOCAL),number_of_values_y,MPI_DOUBLE_PRECISION, &
  !       receiver_top_shift,message_tag,p0(:,-1:0),number_of_values_y, &
  !       MPI_DOUBLE_PRECISION,sender_top_shift,message_tag,MPI_COMM_WORLD,message_status,code)
  ! call MPI_SENDRECV(p0(:,1:2),number_of_values_y,MPI_DOUBLE_PRECISION, &
  !       receiver_bottom_shift,message_tag,p0(:,NY_LOCAL+1:NY_LOCAL+2),number_of_values_y, &
  !       MPI_DOUBLE_PRECISION,sender_bottom_shift,message_tag,MPI_COMM_WORLD,message_status,code)
...
!--------------------------------------------------------
 ...
 ! rhop
  call MPI_SENDRECV(rhop(NX_LOCAL-1:NX_LOCAL,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
         receiver_right_shift,message_tag,rhop(-1:0,:),number_of_values_x, &
         MPI_DOUBLE_PRECISION,sender_right_shift,message_tag,MPI_COMM_WORLD,message_status,code)
 ! call MPI_SENDRECV(rhop(1,:),number_of_values_x/2,MPI_DOUBLE_PRECISION, &
 !        receiver_left_shift,message_tag,rhop(NX_LOCAL+1,:),number_of_values_x/2, &
 !        MPI_DOUBLE_PRECISION,sender_left_shift,message_tag,MPI_COMM_WORLD,message_status,code)
  ! pressure
  call MPI_SENDRECV(pressure(NX_LOCAL-1:NX_LOCAL,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
         receiver_right_shift,message_tag,pressure(-1:0,:),number_of_values_x, &
         MPI_DOUBLE_PRECISION,sender_right_shift,message_tag,MPI_COMM_WORLD,message_status,code)
  call MPI_SENDRECV(pressure(1:2,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
         receiver_left_shift,message_tag,pressure(NX_LOCAL+1:NX_LOCAL+2,:),number_of_values_x, &
         MPI_DOUBLE_PRECISION,sender_left_shift,message_tag,MPI_COMM_WORLD,message_status,code)
 ...
 ! call MPI_SENDRECV(windx(:,1:2),number_of_values_y,MPI_DOUBLE_PRECISION, &
 !        receiver_bottom_shift,message_tag,windx(:,NY_LOCAL+1:NY_LOCAL+2),number_of_values_y, &
 !        MPI_DOUBLE_PRECISION,sender_bottom_shift,message_tag,MPI_COMM_WORLD,message_status,code)
 ! call MPI_SENDRECV(windx(:,NY_LOCAL-1:NY_LOCAL),number_of_values_y,MPI_DOUBLE_PRECISION, &
 !        receiver_top_shift,message_tag,windx(:,-1:0),number_of_values_y, &
 !        MPI_DOUBLE_PRECISION,sender_top_shift,message_tag,MPI_COMM_WORLD,message_status,code)
     
  ! vx
  call MPI_SENDRECV(vx_old(1:2,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
         receiver_left_shift,message_tag,vx_old(NX_LOCAL+1:NX_LOCAL+2,:),number_of_values_x, &
         MPI_DOUBLE_PRECISION,sender_left_shift,message_tag,MPI_COMM_WORLD,message_status,code)
  call MPI_SENDRECV(vx_old(NX_LOCAL-1:NX_LOCAL,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
         receiver_right_shift,message_tag,vx_old(-1:0,:),number_of_values_x, &
         MPI_DOUBLE_PRECISION,sender_right_shift,message_tag,MPI_COMM_WORLD,message_status,code)

  call MPI_SENDRECV(vx_old(:,1:2),number_of_values_y,MPI_DOUBLE_PRECISION, &
         receiver_bottom_shift,message_tag,vx_old(:,NY_LOCAL+1:NY_LOCAL+2),number_of_values_y, &
         MPI_DOUBLE_PRECISION,sender_bottom_shift,message_tag,MPI_COMM_WORLD,message_status,code)
  call MPI_SENDRECV(vx_old(:,NY_LOCAL-1:NY_LOCAL),number_of_values_y,MPI_DOUBLE_PRECISION, &
         receiver_top_shift,message_tag,vx_old(:,-1:0),number_of_values_y, &
         MPI_DOUBLE_PRECISION,sender_top_shift,message_tag,MPI_COMM_WORLD,message_status,code)
  ...
  ! vy
    ...
    call MPI_SENDRECV(vy_old(:,1:2),number_of_values_y,MPI_DOUBLE_PRECISION, &
         receiver_bottom_shift,message_tag,vy_old(:,NY_LOCAL+1:NY_LOCAL+2),number_of_values_y, &
         MPI_DOUBLE_PRECISION,sender_bottom_shift,message_tag,MPI_COMM_WORLD,message_status,code)
   call MPI_SENDRECV(vy_old(:,NY_LOCAL-1:NY_LOCAL),number_of_values_y,MPI_DOUBLE_PRECISION, &
         receiver_top_shift,message_tag,vy_old(:,-1:0),number_of_values_y, &
         MPI_DOUBLE_PRECISION,sender_top_shift,message_tag,MPI_COMM_WORLD,message_status,code)
         
  ! windy
  !call MPI_SENDRECV(windy(NX_LOCAL,:),number_of_values_x/2,MPI_DOUBLE_PRECISION, &
  !       receiver_right_shift,message_tag,windy(0,:),number_of_values_x/2, &
  !       MPI_DOUBLE_PRECISION,sender_right_shift,message_tag,MPI_COMM_WORLD,message_status,code)
  ...
  !
  !call MP!I_SENDRECV(rho0(NX_LOCAL-1:NX_LOCAL,NY_LOCAL-1:NY_LOCAL),number_of_values_corner,MPI_DOUBLE_PRECISION, &
 !        receiver_right_top_shift,message_tag,rho0(-1:0,-1:0),number_of_values_corner, &
 !        MPI_DOUBLE_PRECISION,sender_right_top_shift,message_tag,MPI_COMM_WORLD,message_status,code)
 ! call MPI_SENDRECV(rho0(NX_LOCAL-1:NX_LOCAL,1:2),number_of_values_corner,MPI_DOUBLE_PRECISION, &
         !receiver_right_bottom_shift,message_tag,rho0(-1:0,NY_LOCAL+1:NY_LOCAL+2),number_of_values_corner, &
    ...
    call MPI_SENDRECV(vy_old(NX_LOCAL-1:NX_LOCAL,NY_LOCAL-1:NY_LOCAL),number_of_values_corner,MPI_DOUBLE_PRECISION, &
         ...
         MPI_DOUBLE_PRECISION,sender_right_top_shift,message_tag,MPI_COMM_WORLD,message_status,code)
   ! call MPI_SENDRECV(windy(NX_LOCAL-1:NX_LOCAL,NY_LOCAL-1:NY_LOCAL),number_of_values_corner,MPI_DOUBLE_PRECISION, &
    !     receiver_right_top_shift,message_tag,windy(-1:0,-1:0),number_of_values_corner, &
     !    MPI_DOUBLE_PRECISION,sender_right_top_shift,message_tag,MPI_COMM_WORLD,message_status,code)
 ...
 ! rho0
  ...
  ! rhop
   call MPI_SENDRECV(rhop(:,1:2),number_of_values_y,MPI_DOUBLE_PRECISION, &
         receiver_bottom_shift,message_tag,rhop(:,NY_LOCAL+1:NY_LOCAL+2),number_of_values_y, &
         MPI_DOUBLE_PRECISION,sender_bottom_shift,message_tag,MPI_COMM_WORLD,message_status,code)
  call MPI_SENDRECV(rhop(:,NY_LOCAL-1:NY_LOCAL),number_of_values_y,MPI_DOUBLE_PRECISION, &
         receiver_top_shift,message_tag,rhop(:,-1:0),number_of_values_y, &
         MPI_DOUBLE_PRECISION,sender_top_shift,message_tag,MPI_COMM_WORLD,message_status,code)  
     
          
 ! pressure
   call MPI_SENDRECV(pressure(:,1:2),number_of_values_y,MPI_DOUBLE_PRECISION, &
         receiver_bottom_shift,message_tag,pressure(:,NY_LOCAL+1:NY_LOCAL+2),number_of_values_y, &
         MPI_DOUBLE_PRECISION,sender_bottom_shift,message_tag,MPI_COMM_WORLD,message_status,code)
   call MPI_SENDRECV(pressure(:,NY_LOCAL-1:NY_LOCAL),number_of_values_y,MPI_DOUBLE_PRECISION, &
         receiver_top_shift,message_tag,pressure(:,-1:0),number_of_values_y, &
         MPI_DOUBLE_PRECISION,sender_top_shift,message_tag,MPI_COMM_WORLD,message_status,code)         
  
 ! windy
  call MPI_SENDRECV(windy(1:2,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
         receiver_left_shift,message_tag,windy(NX_LOCAL+1:NX_LOCAL+2,:),number_of_values_x, &
         MPI_DOUBLE_PRECISION,sender_left_shift,message_tag,MPI_COMM_WORLD,message_status,code)
  call MPI_SENDRECV(windy(NX_LOCAL-1:NX_LOCAL,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
         receiver_right_shift,message_tag,windy(-1:0,:),number_of_values_x, &
         MPI_DOUBLE_PRECISION,sender_right_shift,message_tag,MPI_COMM_WORLD,message_status,code)
  ...
  ! vy
  call MPI_SENDRECV(vy_old(1:2,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
         receiver_left_shift,message_tag,vy_old(NX_LOCAL+1:NX_LOCAL+2,:),number_of_values_x, &
         MPI_DOUBLE_PRECISION,sender_left_shift,message_tag,MPI_COMM_WORLD,message_status,code)
  call MPI_SENDRECV(vy_old(NX_LOCAL-1:NX_LOCAL,:),number_of_values_x,MPI_DOUBLE_PRECISION, &
         receiver_right_shift,message_tag,vy_old(-1:0,:),number_of_values_x, &
         MPI_DOUBLE_PRECISION,sender_right_shift,message_tag,MPI_COMM_WORLD,message_status,code)
  ...
  ! windx
  call MPI_SENDRECV(windx(NX_LOCAL,:),number_of_values_x/2,MPI_DOUBLE_PRECISION, &
         receiver_right_shift,message_tag,windx(0,:),number_of_values_x/2, &
         MPI_DOUBLE_PRECISION,sender_right_shift,message_tag,MPI_COMM_WORLD,message_status,code)
  ...
  !
    call MPI_SENDRECV(rho0(1:2,1:2),number_of_values_corner,MPI_DOUBLE_PRECISION, &
         receiver_bottom_left_shift,message_tag,rho0(NX_LOCAL+1:Nx_LOCAL+2,NY_LOCAL+1:NY_LOCAL+2),number_of_values_corner, &
         MPI_DOUBLE_PRECISION,sender_bottom_left_shift,message_tag,MPI_COMM_WORLD,message_status,code)   
    call MPI_SENDRECV(rho0(NX_LOCAL-1:NX_LOCAL,1:2),number_of_values_corner,MPI_DOUBLE_PRECISION, &
         receiver_bottom_right_shift,message_tag,rho0(-1:0,NY_LOCAL+1:NY_LOCAL+2),number_of_values_corner, &
  ...
  call MPI_SENDRECV(vx_old(1:2,1:2),number_of_values_corner,MPI_DOUBLE_PRECISION, &
         ...
         MPI_DOUBLE_PRECISION,sender_bottom_left_shift,message_tag,MPI_COMM_WORLD,message_status,code)
    call MPI_SENDRECV(windx(1:2,1:2),number_of_values_corner,MPI_DOUBLE_PRECISION, &
         receiver_bottom_left_shift,message_tag,windx(NX_LOCAL+1:NX_LOCAL+2,NY_LOCAL+1:NY_LOCAL+2),number_of_values_corner, &
         MPI_DOUBLE_PRECISION,sender_bottom_left_shift,message_tag,MPI_COMM_WORLD,message_status,code)     
...
! vy is staggered by half a grid cell along X and along Y with respect to vx
  if ((ix_rec(irec) / NX_LOCAL) == i_rank .and.iy_rec(irec) / NY_LOCAL == j_rank ) then
...
! output information
  if ((mod(it,IT_DISPLAY) == 0 .or. it == 5) .and. (save_sismos)) then
    ...
    call MPI_REDUCE(maxval(abs(pressure(1:NX_LOCAL,1:NY_LOCAL))), &
